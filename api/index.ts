...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1200" height="1600" viewBox="0 0 1200 1600">
  ...
  <g>
    <rect x="60" y="170" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    ...
    <use href="#checkIcon" x="215" y="180" width="14" height="14" color="#166534"/>
  </g>
  
  <g>
    <rect x="260" y="170" width="180" height="80" rx="8" class="card-info" stroke-width="1"/>
    <text x="275" y="190" class="card-label">Test Coverage</text>
    <text x="275" y="215" class="card-value value-info">85%</text>
  </g>
  
  <g>
    <rect x="460" y="170" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="475" y="190" class="card-label">Linting</text>
    <text x="475" y="215" class="card-value value-success">Clean</text>
  </g>
  
  <g>
    <rect x="660" y="170" width="180" height="80" rx="8" class="card-warning" stroke-width="1"/>
    <text x="675" y="190" class="card-label">Code Smells</text>
    <text x="675" y="215" class="card-value value-warning">3</text>
  </g>
  
  <!-- Code Quality Cards Row 2 -->
  <g>
    <rect x="60" y="270" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="75" y="290" class="card-label">Tech Debt</text>
    <text x="75" y="315" class="card-value value-success">2.1%</text>
  </g>
  
  <g>
    <rect x="260" y="270" width="180" height="80" rx="8" class="card-neutral" stroke-width="1"/>
    <text x="275" y="290" class="card-label">Complexity</text>
    <text x="275" y="315" class="card-value">3.2</text>
  </g>
  
  <g>
    <rect x="460" y="270" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="475" y="290" class="card-label">Static Analysis</text>
    <text x="475" y="315" class="card-value value-success">A+</text>
  </g>
  
  <g>
    <rect x="660" y="270" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="675" y="290" class="card-label">Security</text>
    <text x="675" y="315" class="card-value value-success">Passed</text>
  </g>
  ...
  <g>
    <rect x="60" y="410" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="75" y="430" class="card-label">Last Commit</text>
    <text x="75" y="455" class="card-value value-success">3d ago</text>
  </g>
  
  <g>
    <rect x="260" y="410" width="180" height="80" rx="8" class="card-info" stroke-width="1"/>
    <text x="275" y="430" class="card-label">Commits/Week</text>
    <text x="275" y="455" class="card-value value-info" id="commitsWeek">28</text>
  </g>
  
  <g>
    <rect x="460" y="410" width="180" height="80" rx="8" class="card-info" stroke-width="1"/>
    <text x="475" y="430" class="card-label">Open PRs</text>
    <text x="475" y="455" class="card-value value-info">4</text>
  </g>
  
  <g>
    <rect x="660" y="410" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="675" y="430" class="card-label">PRs Merged</text>
    <text x="675" y="455" class="card-value value-success" id="prsMerged">74</text>
  </g>
  
  <!-- Activity Cards Row 2 -->
  <g>
    <rect x="60" y="510" width="180" height="80" rx="8" class="card-warning" stroke-width="1"/>
    <text x="75" y="530" class="card-label">Open Issues</text>
    <text x="75" y="555" class="card-value value-warning" id="openIssues">1089</text>
  </g>
  
  <g>
    <rect x="260" y="510" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="275" y="530" class="card-label">Closed Issues</text>
    <text x="275" y="555" class="card-value value-success">23</text>
  </g>
  
  <g>
    <rect x="460" y="510" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="475" y="530" class="card-label">Response Time</text>
    <text x="475" y="555" class="card-value value-success">8h</text>
  </g>
  
  <g>
    <rect x="660" y="510" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="675" y="530" class="card-label">Fix Time</text>
    <text x="675" y="555" class="card-value value-success">3d</text>
  </g>
  ...
  <!-- Community Cards -->
  <g>
    <rect x="60" y="650" width="180" height="80" rx="8" class="card-neutral" stroke-width="1"/>
    <text x="75" y="670" class="card-label">Contributors</text>
    <text x="75" y="695" class="card-value" id="contributors">1933</text>
  </g>
  
  <g>
    <rect x="260" y="650" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="275" y="670" class="card-label">Active Devs</text>
    <text x="275" y="695" class="card-value value-success">6</text>
  </g>
  
  <g>
    <rect x="460" y="650" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="475" y="670" class="card-label">Retention</text>
    <text x="475" y="695" class="card-value value-success">78%</text>
  </g>
  
  <g>
    <rect x="660" y="650" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="675" y="670" class="card-label">Growth</text>
    <text x="675" y="695" class="card-value value-success">+5%</text>
  </g>
  ...
  <!-- Engagement Cards -->
  <g>
    <rect x="60" y="790" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="75" y="810" class="card-label">Stars</text>
    <text x="75" y="835" class="card-value value-success" id="stars">236k</text>
    <use href="#starIcon" x="215" y="800" width="12" height="12" color="#166534"/>
  </g>
  
  <g>
    <rect x="260" y="790" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="275" y="810" class="card-label">Forks</text>
    <text x="275" y="835" class="card-value value-success" id="forks">48,697</text>
  </g>
  
  <g>
    <rect x="460" y="790" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="475" y="810" class="card-label">Watchers</text>
    <text x="475" y="835" class="card-value value-success" id="watchers">6,733</text>
  </g>
  
  <g>
    <rect x="660" y="790" width="180" height="80" rx="8" class="card-neutral" stroke-width="1"/>
    <text x="675" y="810" class="card-label">Discussions</text>
    <text x="675" y="835" class="card-value">20</text>
  </g>
  ...
  <!-- Release Cards -->
  <g>
    <rect x="60" y="930" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="75" y="950" class="card-label">Latest Release</text>
    <text x="75" y="975" class="card-value value-success">v2.3.1</text>
  </g>
  
  <g>
    <rect x="260" y="930" width="180" height="80" rx="8" class="card-neutral" stroke-width="1"/>
    <text x="275" y="950" class="card-label">Releases/Month</text>
    <text x="275" y="975" class="card-value">2</text>
  </g>
  
  <g>
    <rect x="460" y="930" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="475" y="950" class="card-label">Changelog</text>
    <text x="475" y="975" class="card-value value-success">Updated</text>
  </g>
  
  <g>
    <rect x="660" y="930" width="180" height="80" rx="8" class="card-success" stroke-width="1"/>
    <text x="675" y="950" class="card-label">SemVer</text>
    <text x="675" y="975" class="card-value value-success">Compliant</text>
  </g>
